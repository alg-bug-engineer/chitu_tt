...
from chitu.utils import tt_all_reduce, tt_all_gather
...
if has_ttnn:
    from chitu.models.tt_model_config import TensorGroup, OpGroup
...
class TransformerBlock(LightweightModule):
    def __init__(
        ...
        ActualAttentionClass = attention_class if attention_class is not None else Attention
